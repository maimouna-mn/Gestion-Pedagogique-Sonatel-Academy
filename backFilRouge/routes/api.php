...
Route::post('/user/storeClasse', [UserController::class, 'storeClasse']);
...
// SupprimerSession(Request $request,$session_cours_classe_id)  storeClasse
Route::get('/session/supprimer/{session_cours_classe_id}',[sessionController::class,"SupprimerSession"]);
